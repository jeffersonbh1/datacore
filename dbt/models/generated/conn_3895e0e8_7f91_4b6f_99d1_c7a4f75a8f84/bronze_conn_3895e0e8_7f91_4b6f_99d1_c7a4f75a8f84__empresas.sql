...
-- GERADO por server/dbtCodegen.ts — integração conn_3895e0e8_7f91_4b6f_99d1_c7a4f75a8f84, tabela empresas.
...
with raw_source as (
    select * from {{ ref('stg_conn_3895e0e8_7f91_4b6f_99d1_c7a4f75a8f84__empresas') }}
),
